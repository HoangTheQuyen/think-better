...
After getting the plan, use domain-specific searches for detailed guidance:
...
### Step 4: Compare Options (if applicable)

When comparing specific options, generate a comparison matrix:
...
### Step 5: Document the Decision (recommended)

Create a decision journal entry for future reflection:
